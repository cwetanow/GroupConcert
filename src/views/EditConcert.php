      ...
      <div class="error">
                <?php if (isset($_GET['title']) && $_GET['title'] == 'false'): ?>
                    Title is required
                                         ...
                                         <input type="text" id="city" name="city" class="form-control" placeholder="City" required value="<?=$concert->getCity()?>"  >
      <div class="error">
                                         ...
                                         <input type="text" id="address" name="address" class="form-control" placeholder="Address" required value="<?=$concert->getAddress()?>" >
      <div class="error">
